...
download_release() {
	...
	# TODO: Adapt the release URL convention for apk-editor
	url="$GH_REPO/releases/download/V${version}/APKEditor-${version}.jar"
...
install_version() {
	...
	(
		...
		# TODO: Assert apk-editor executable exists.
		local tool_cmd
